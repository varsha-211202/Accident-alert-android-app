    ...
    <section class="ftco-section ftco-no-pt bg-light">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
          	<span class="subheading">Police Portal</span>
...
<h4>User Details</h4>
    ...
    $sql = "SELECT * FROM alert_table where cond=3 ORDER by id DESC";
$result = mysqli_query($conn,$sql);
?>
<h4>Driver Details</h4>
      ...
      <tr>
        ...
        <td><?php echo $rows['map1'];?></td>
        <td><?php echo $rows['map2'];?></td>
    ...
    $sql = "SELECT * FROM alert_table where cond=1 ORDER by id DESC";
$result = mysqli_query($conn,$sql);
?>
